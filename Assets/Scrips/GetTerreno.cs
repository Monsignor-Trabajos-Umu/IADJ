...
public class GetTerreno : MonoBehaviour
{
    ...
    private float[] GetTextureix(Vector3 WorldPos, Terrain t)
    {
        ...
        var mapX = (int) ((WorldPos.x - terrainPos.x) / terrainData.size.x *
                          terrainData.alphamapWidth);
        var mapZ = (int) ((WorldPos.z - terrainPos.z) / terrainData.size.z *
        ...
        var cellix = new float[splatmapData.GetUpperBound(2) + 1];

        for (var n = 0; n < cellix.Length; n++) cellix[n] = splatmapData[0, 0, n];
        return cellix;
    }
    ...
    public int GetainTexture(Vector3 WorldPos, Terrain t)
    {
        ...
        // on the main terrain at this world position.
        var mix = GetTextureix(WorldPos, t);
